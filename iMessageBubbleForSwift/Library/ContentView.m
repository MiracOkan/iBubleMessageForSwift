...
-(instancetype)initWithTextView:(UITextView *)textView ChatTextViewHeightConstraint:(NSLayoutConstraint *)chatTextViewHeightConstraint contentView:(UIView *)contentView ContentViewHeightConstraint:(NSLayoutConstraint *)contentViewHeightConstraint andContentViewBottomConstraint:(NSLayoutConstraint *)contentViewBottomConstraint
{
    self = [super init];
...
- (void)handleKeyboardWillShow:(NSNotification *)paramNotification
{
    ...
    __unused CGSize kbSize = [info[UIKeyboardFrameBeginUserInfoKey] CGRectValue].size;
    
    // size of the keyb that is about to appear
    CGSize kbSizeNew = [info[UIKeyboardFrameEndUserInfoKey] CGRectValue].size;
